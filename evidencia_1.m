...
a3=atand(-1/(funcion_2(xrecm)));
%xrec1=(xrec-((20/(sind(a1)))));
xrecm1=(xrecm-((20/(sind(a2)))));
xrecm2=(xrecm1-((10/(sind(a2)))));
xrecm3=(xrecm1-((80/(sind(a3)))));

hold on
% y2 = @(X) funcion_2(xrec) * (X-xrec1) + funcion(xrec);
y3 = @(X) funcion_2(xrecm) * (X-xrecm1) + funcion(xrecm);
y4 = @(X) funcion_2(xrecm) * (X-xrecm2) + funcion(xrecm);
y5 = @(X) (-1/funcion_2(xrecm)) * (X-xrecm1) + funcion(xrecm);
y6 = @(X) (-1/funcion_2(xrecm)) * (X-xrecm3) + funcion(xrecm);
% fplot(y2,[xrec xrec+50],'b')
fplot(y3,[xrecm-40 xrecm+40],'b')
fplot(y4,[xrecm-40 xrecm+40],'b')
fplot(y5,[xrecm-40 xrecm+40],'b')
fplot(y6,[xrecm-40 xrecm+40],'b')
hold off
